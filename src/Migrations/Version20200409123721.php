 ...
 */
final class Version20200409123721 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, channel_id INTEGER NOT NULL, user VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, timestamp INTEGER NOT NULL)');
